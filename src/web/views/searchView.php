    ...
    <script>
        function displayImages(input){
            if(input.length == 0){
                ...
                httpReq.open("GET", "../web/frontcontroller.php?action=/gallery/search/result&search="+input, true);
                httpReq.send();
            }
        }
    </script>
...
<body>
    ...
    <main>
        <br />
        <h3>Wyszukaj zdjęcie po tytule</h3>
        <form action="../web/frontcontroller.php?action=/gallery/search/result" method="post">
            <input type="text" name="search" onkeyup="displayImages(this.value)"/>
        </form>
        <p id="res"></p>
    </main>

...
<body>
    ...
    <main>
        <br>
        <h3>Zaloguj się</h3>
        <form action="../web/frontcontroller.php?action=/loginUser" method="post" enctype="multipart/form-data">
            <div style="display: flex"><pre>Login:          </pre><input type="text" name="login"/></div>
            <div style="display: flex"><pre>Hasło:          </pre><input type="password" name="password"/></div>
            <div style="display: flex"><input type="submit" value="Zaloguj"/></div>
        </form>
        <h3>Rejestracja</h3>
        <form action="../web/frontcontroller.php?action=/register" method="post" enctype="multipart/form-data">
            <div style="display: flex"><pre>Login:          </pre><input type="text" name="registerLogin"/></div>
            <div style="display: flex"><pre>Email:          </pre><input type="email" name="registerMail"/></div>
            <div style="display: flex"><pre>Hasło:          </pre><input type="password" name="registerPassword"/></div>
            <div style="display: flex"><pre>Powtórz hasło:  </pre><input type="password" name="registerPasswordRepeat"/></div>
            <div style="display: flex"><input type="submit" value="Rejestracja"/></div>
        </form>
    </main>
</body>
</html>